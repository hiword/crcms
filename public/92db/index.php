...
<head>
    ...
    <link href="../vendor/common/css/global.css" rel="stylesheet">
    <link href="css/92db.css" rel="stylesheet">
		...
		<div class="col-md-9 main-left">
			...
			<article class="article-list mb20">	<!-- 			
				...
				<div class="list-info row clearfix">
					...
					<div class="other col-md-8 col-xs-6 text-right pull-right">
						<span class="hidden-xs hidden-sm">
							<a href="###" class="tag ml5"><i class="glyphicon glyphicon-tag"></i>string</a>
							<a href="###" class="tag ml5"><i class="glyphicon glyphicon-tag"></i>string</a>
							<a href="###" class="tag ml5"><i class="glyphicon glyphicon-tag"></i>string</a>
					...
					<div class="hidden-md hidden-lg col-xs-12 mt15 tags">
						<a href="###" class="tag ml5"><i class="glyphicon glyphicon-tag"></i>string</a>
						<a href="###" class="tag ml5"><i class="glyphicon glyphicon-tag"></i>string</a>
						<a href="###" class="tag ml5"><i class="glyphicon glyphicon-tag"></i>string</a>
						<a href="###" class="tag ml5"><i class="glyphicon glyphicon-tag"></i>tags</a>
