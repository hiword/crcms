...
//         'Log',
    ...
    'agents' => [
        ...
        'YunTongXun' => [
            ...
            'accountSid' => 'aaf98f8951af2ba80151b465eb48127b',

            //主帐号令牌,对应官网开发者主账号下的 AUTH TOKEN
            'accountToken' => 'f63d34c25d4048f59622928532f345bf ',
        ...
        'Luosimao' => [
            // 短信 API key
            // 在管理中心->短信->触发发送下查看
            'apikey' => 'e6daf67dc2262ef12754f1f6501060d4',

            // 语言验证 API key
            // 在管理中心->语音->语音验证下查看
            'voiceApikey' => 'cf54adc6032a51e3d2faa5fdd89f4ae3',
        ],
        ...
        'Ucpaas' => [
            //主帐号,对应开官网发者主账号下的 ACCOUNT SID
            'accountSid' => '35b78aec62d1e8db2b586e30cd47ac4d',

            //主帐号令牌,对应官网开发者主账号下的 AUTH TOKEN
            'accountToken' => '0e2b4ac6d7e74b3dad858387aeb5230b',

            //应用Id，在官网应用列表中点击应用，对应应用详情中的APP ID
            //在开发调试的时候，可以使用官网自动为您分配的测试Demo的APP ID
            'appId' => '0b19ca39f3ca49969581dfac464f3e05',
        ],
