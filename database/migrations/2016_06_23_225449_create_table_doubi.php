...
class CreateTableDoubi extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
    	Schema::create('doubis', function(Blueprint $table)
    	{
    		$table->unsignedInteger('id',true);
    		
    		$table->char('picture',255);
    		$table->char('seo_title',150);
    		
    		$table->unsignedInteger('sort')->default(0);
    		$table->tinyInteger('status',false,true)->default(0);
    		
//     		$table->unsignedMediumInteger('agree')->default(0);
//     		$table->unsignedMediumInteger('oppose')->default(0);
