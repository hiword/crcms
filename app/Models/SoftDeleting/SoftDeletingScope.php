<?php namespace App\Models\SoftDeleting;
...
class SoftDeletingScope implements ScopeInterface {
	...
	protected function addRestore(Builder $builder)
	{
		$builder->macro('restore', function(Builder $builder)
		{
			...
			return $builder->update(array($builder->getModel()->getDeletedAtColumn() => 0));
		});
	}
	...
	{
		return isset($where['operator']) && $where['operator'] == '=' && $where['column'] == $column;
	}
