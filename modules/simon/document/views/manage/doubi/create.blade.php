...
@endsection
@section('main')
<form action="{{url('manage/doubi/store')}}" class="valid-form" method="post">
{{csrf_field()}}
<div class="row pb20">
	<div class="col-md-9">
		...
		<div class="form-group">
			...
			<textarea class="form-control" style="height: 150px;" name="document_data[content]"></textarea>
		...
		<div class="form-group">
			...
			<input class="form-control" type="text" name="document[seo_title]" datatype="*1-120" placeholder="">
			<p class="help-block Validform_checktip"></p>
		</div>
		
		<div class="form-group">
			<label class=" Validform_label label-name">SEO关键字</label>
			<input class="form-control" type="text" name="document_data[seo_keyword]" datatype="*1-120" placeholder="">
			<p class="help-block Validform_checktip"></p>
		</div>
		<div class="form-group">
			<label class=" Validform_label label-name">SEO描述</label>
			<textarea class="form-control" name="document_data[seo_intro]"></textarea>
			<p class="help-block Validform_checktip"></p>
		</div>
	...
	<div class="col-md-3">
		...
		<div class="form-group">
			...
			<input type="hidden" name="document[picture]" />
			<a href="###" class="thumbnail upload-dialog"><img id="upload-single-btn" src="http://placehold.it/300x180" alt="" /></a>
			<p class="help-block Validform_checktip"></p>
		</div>
